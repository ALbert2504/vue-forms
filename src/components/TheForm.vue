<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" @blur="validateInput" v-model.trim="userName" />
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-tutorials" name="interest" type="checkbox" value="tutrorials" v-model="interest" />
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log(31);
      console.log('Referred: ' + this.referrer);
      this.referrer = 'wom';
